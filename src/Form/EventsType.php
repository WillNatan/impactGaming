...
class EventsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('support', EntityType::class, ['required'=>false,'class'=>Platform::class, 'choice_label'=>'platformName', 'attr'=>['class'=>'form-control'],'label'=>'Support', 'placeholder'=>'Choisissez un support','multiple'=>true])
            ->add('availableGames', EntityType::class,['required'=>false,'label'=>"Jeux disponibles",'class'=>AvailableGames::class, 'choice_label'=>'gameName','multiple'=>true,'attr'=>['class'=>'form-control']])
